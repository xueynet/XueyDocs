<template><h1 id="plugin-package-插件打包命令"><a class="header-anchor" href="#plugin-package-插件打包命令">#</a> plugin package 插件打包命令</h1>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms plugin package
    -h, --help
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>数据库恢复命令必须包含从指定的文件夹中恢复数据 --directory 参数。</p>
