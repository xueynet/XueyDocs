<template><h1 id="plugin-publish-插件发布命令"><a class="header-anchor" href="#plugin-publish-插件发布命令">#</a> plugin publish 插件发布命令</h1>
<p>数据库恢复命令，用于从备份文件中恢复数据结构及数据至指定数据库。</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>数据库恢复命令支持MySQL、SQLSERVER、PostgreSQL 以及 Sqlite数据库。</p>
</div>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>数据库恢复命令不仅可以用于恢复 XYCMS 系统数据，还可用于任何需要恢复数据文件至数据库的场合。</p>
</div>
<h3 id="用法"><a class="header-anchor" href="#用法">#</a> 用法</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms plugin publish
    -v, --version<span class="token operator">=</span>VALUE
    -h, --help
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>数据库恢复命令必须包含从指定的文件夹中恢复数据 <code>--directory</code> 参数。</p>
...
<td style="text-align:left">发布版本</td>
</tr>
<tr>
