<template><h1 id="data-update-数据库升级命令"><a class="header-anchor" href="#data-update-数据库升级命令">#</a> data update 数据库升级命令</h1>
<p>数据库备份命令，用于备份数据库结构以及数据至指定文件夹中。</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>数据库备份命令不仅可以用于备份 XYCMS 系统数据，还可用于任何需要备份数据库至文件的场合。</p>
</div>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms data backup
    ...
    --content-split
    -h, --help
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>可以设置可选参数控制备份选项。</p>
...
<td style="text-align:left">指定需要升级至最新版本的备份数据文件夹</td>
</tr>
<tr>
<td style="text-align:left">--content-split</td>
<td style="text-align:left"></td>
<td style="text-align:left">拆分内容表</td>
</tr>
<tr>
