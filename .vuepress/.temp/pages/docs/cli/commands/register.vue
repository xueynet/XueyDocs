<template><h1 id="register-注册命令"><a class="header-anchor" href="#register-注册命令">#</a> register 注册命令</h1>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms register
    -u, --username<span class="token operator">=</span>VALUE
    --mobile<span class="token operator">=</span>VALUE
    --email<span class="token operator">=</span>VALUE
    -p, --password<span class="token operator">=</span>VALUE
    -h, --help
...
<td style="text-align:left">登录用户名</td>
</tr>
<tr>
<td style="text-align:left">--mobile</td>
<td style="text-align:left"></td>
<td style="text-align:left">登录手机号</td>
</tr>
<tr>
<td style="text-align:left">--email</td>
<td style="text-align:left"></td>
<td style="text-align:left">登录邮箱</td>
</tr>
<tr>
