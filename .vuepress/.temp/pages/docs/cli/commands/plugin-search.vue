<template><h1 id="plugin-search-插件搜索命令"><a class="header-anchor" href="#plugin-search-插件搜索命令">#</a> plugin search 插件搜索命令</h1>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms plugin search
    -h, --help
