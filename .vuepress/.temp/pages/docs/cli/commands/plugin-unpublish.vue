<template><h1 id="plugin-unpublish-插件下架命令"><a class="header-anchor" href="#plugin-unpublish-插件下架命令">#</a> plugin unpublish 插件下架命令</h1>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>xycms plugin unpublish
    -h, --help
