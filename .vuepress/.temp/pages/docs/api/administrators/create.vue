<template><h1 id="新增管理员-api"><a class="header-anchor" href="#新增管理员-api">#</a> 新增管理员 API</h1>
<p>注册新管理员，使用POST发起请求，请求地址为<code>/api/v1/administrators</code></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>POST /api/v1/administrators HTTP/1.1
...
<td style="text-align:left">字符串</td>
<td style="text-align:left">否</td>
<td style="text-align:left">密码加密格式，有Clear及Encrypt两种，分别代表不加密以及可逆加密。</td>
</tr>
<tr>
...
<tr>
<td style="text-align:left">LastActivityDate</td>
<td style="text-align:left">日期</td>
<td style="text-align:left">否</td>
<td style="text-align:left">最后活动时间</td>
</tr>
<tr>
<td style="text-align:left">CountOfLogin</td>
<td style="text-align:left">数字</td>
<td style="text-align:left">否</td>
<td style="text-align:left">登录次数</td>
</tr>
<tr>
<td style="text-align:left">CreatorUserName</td>
<td style="text-align:left">字符串</td>
<td style="text-align:left">否</td>
...
<td style="text-align:left">数字</td>
<td style="text-align:left">否</td>
<td style="text-align:left">管理员所属部门 Id</td>
</tr>
<tr>
<td style="text-align:left">areaId</td>
<td style="text-align:left">数字</td>
<td style="text-align:left">否</td>
<td style="text-align:left">管理员所属区域 Id</td>
</tr>
<tr>
<td style="text-align:left">displayName</td>
<td style="text-align:left">字符串</td>
<td style="text-align:left">否</td>
<td style="text-align:left">管理员姓名</td>
</tr>
<tr>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">"value"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">"password"</span><span class="token operator">:</span> <span class="token string">"eZ4LFYjgfHw="</span><span class="token punctuation">,</span>
    ...
    <span class="token property">"passwordSalt"</span><span class="token operator">:</span> <span class="token string">"OrUDGQFTyboATfzWYocNOw=="</span><span class="token punctuation">,</span>
    <span class="token property">"creationDate"</span><span class="token operator">:</span> <span class="token string">"2018-06-29 16:48:35"</span><span class="token punctuation">,</span>
    <span class="token property">"lastActivityDate"</span><span class="token operator">:</span> <span class="token string">"2018-06-29 16:48:35"</span><span class="token punctuation">,</span>
    ...
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"test@sample.com"</span><span class="token punctuation">,</span>
    <span class="token property">"mobile"</span><span class="token operator">:</span> <span class="token string">"13888888888"</span>
