<template><h1 id="获取管理员-api"><a class="header-anchor" href="#获取管理员-api">#</a> 获取管理员 API</h1>
<p>获取管理员，使用GET发起请求，请求地址为<code>/api/v1/administrators/{id}</code></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>GET /api/v1/administrators/{id} HTTP/1.1
...
<td style="text-align:left">管理员 Id</td>
</tr>
<tr>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>GET /api/v1/administrators/1 HTTP/1.1
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">"value"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">"userName"</span><span class="token operator">:</span> <span class="token string">"test5"</span><span class="token punctuation">,</span>
    <span class="token property">"password"</span><span class="token operator">:</span> <span class="token string">"v8WaUwDj3vE="</span><span class="token punctuation">,</span>
    ...
    <span class="token property">"passwordSalt"</span><span class="token operator">:</span> <span class="token string">"obD8YzQr7PQeLag/3iQSzw=="</span><span class="token punctuation">,</span>
    <span class="token property">"creationDate"</span><span class="token operator">:</span> <span class="token string">"2018-06-30 12:26:54"</span><span class="token punctuation">,</span>
    <span class="token property">"lastActivityDate"</span><span class="token operator">:</span> <span class="token string">"2018-06-30 12:26:54"</span><span class="token punctuation">,</span>
