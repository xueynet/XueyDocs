<template><h1 id="删除管理员-api"><a class="header-anchor" href="#删除管理员-api">#</a> 删除管理员 API</h1>
<p>删除管理员，使用DELETE发起请求，请求地址为<code>/api/v1/administrators/{id}</code></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>DELETE /api/v1/administrators/{id} HTTP/1.1
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>DELETE /api/v1/administrators/1 HTTP/1.1
