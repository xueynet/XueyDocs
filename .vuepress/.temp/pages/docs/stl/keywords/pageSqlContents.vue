<template><h1 id="stl-pagesqlcontents-分页数据列表"><a class="header-anchor" href="#stl-pagesqlcontents-分页数据列表">#</a> <a href="stl:pageSqlContents">stl:pageSqlContents</a> 分页数据列表</h1>
<div class="language-markup ext-html line-numbers-mode"><pre v-pre class="language-markup"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token namespace">stl:</span>pageSqlContents</span>
  <span class="token attr-name">pageNum</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>每页显示的数据数量<span class="token punctuation">"</span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h3 id="说明"><a class="header-anchor" href="#说明">#</a> 说明</h3>
<p>通过 <code>&lt;stl:pageSqlContents&gt;</code> 标签在模板中显示任意数据库中的数据列表。</p>
<p>所有适用于 <code>&lt;stl:sqlContents&gt;</code> 标签的用法均适用于 <code>&lt;stl:pageSqlContents&gt;</code> 标签。</p>
<h3 id="数据库连接"><a class="header-anchor" href="#数据库连接">#</a> 数据库连接</h3>
<p>如果未设置 databaseTypeName，databaseType，connectionStringName，connectionString 属性，标签 <code>&lt;stl:pageSqlContents&gt;</code> 默认从当前 XYCMS 所在的数据库中获取数据，否则将从指定的数据库中获取数据。</p>
...
<div class="language-markup ext-html line-numbers-mode"><pre v-pre class="language-markup"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token namespace">stl:</span>pageSqlContents</span>
  ...
  <span class="token attr-name">connectionStringName</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>RemoteDatabase:ConnectionString<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token namespace">stl:</span>pageSqlContents</span><span class="token punctuation">></span></span>
...
<p>数据库查询有两种方式：</p>
<p><strong>queryString 查询</strong>
第一种方式是通过属性 queryString 或者子标签 <code>&lt;stl:queryString&gt;</code> 直接输入 SQL 语句进行查询，如：</p>
<div class="language-markup ext-html line-numbers-mode"><pre v-pre class="language-markup"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token namespace">stl:</span>pageSqlContents</span>
  <span class="token attr-name">databaseTypeName</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>RemoteDatabase:Type<span class="token punctuation">"</span></span>
...
<p>存储在系统根目录的 xycms.json 文件中的数据库链接字符串名称，默认为系统使用的数据库 ConnectionString。</p>
